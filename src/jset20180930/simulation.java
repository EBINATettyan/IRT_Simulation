...
public class simulation {
	...
	public static void main(String args[]) {
		...
		double difficulty[][] = {
				...
				{ -10, -3.34, -1.55, 1.33, 1.38, 2.91 }, { -10, -3.34, -1.55, 0.33, 1.78, 3.51 },
				{ -10, -1.99, -1.73, 0.08, 1.65, 2.91 }, { -10, -2.53, -1.76, 0.98, 1.73, 2.42 },
				{ -10, -2.22, -1.45, 0.43, 1.50, 2.48 }, { -10, -3.34, -1.55, 1.33, 1.38, 2.91 },
				{ -10, -3.34, -1.55, 0.33, 1.78, 3.51 }, { -10, -1.99, -1.73, 0.08, 1.65, 2.91 },
				{ -10, -2.53, -1.76, 0.98, 1.73, 2.42 }, { -10, -2.22, -1.45, 0.43, 1.50, 2.48 },
				{ -10, -3.34, -1.55, 1.33, 1.38, 2.91 }, { -10, -3.34, -1.55, 0.33, 1.78, 3.51 },
				{ -10, -1.99, -1.73, 0.08, 1.65, 2.91 }, { -10, -2.53, -1.76, 0.98, 1.73, 2.42 },
		...
		try {
			...
			// ファイル書き出し用
			File csv = new File(
					"C:/Users/J14-8002/pleiades/workspace/IRT_Simulation/result/simulation_jset_20180930_VER3.csv");
			// 追記モード
			// 文字コードの指定
